...
export const featureModules: FeatureModule[] = [overviewModule, sitesModule, domainsModule, certificatesModule, filesModule, logsModule, schedulesModule, databasesModule, mysqlModule, adminToolsModule, systemModule, nodeOperationsModule, jobsModule, identityModule, auditModule].sort(
