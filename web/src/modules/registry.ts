...
export const featureModules: FeatureModule[] = [overviewModule, sitesModule, domainsModule, certificatesModule, filesModule, logsModule, schedulesModule, backupsModule, databasesModule, applicationsModule, phpModule, servicesModule, sftpModule, firewallModule, jobsModule, identityModule, auditModule, systemModule].sort(
